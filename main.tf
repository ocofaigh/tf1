...
module "ocp_base" {
  ...
  source                          = "git::https://github.ibm.com/GoldenEye/base-ocp-vpc-module.git?ref=1.11.1"
...
module "cluster_proxy" {
  source                                   = "git::https://github.ibm.com/GoldenEye/cluster-proxy-module.git?ref=2.4.11"
...
module "observability_agents" {
  ...
  source                       = "git::https://github.ibm.com/GoldenEye/observability-agents-module?ref=2.1.13"
  cluster_id                   = module.ocp_base.cluster_id
...
module "ocp_console_patch" {
  ...
  source     = "git::https://github.ibm.com/GoldenEye/ocp-console-patch-module?ref=1.0.12"
  cluster_id = module.ocp_base.cluster_id
}
...
module "ocp_edge_ingress" {
  ...
  source           = "git::https://github.ibm.com/GoldenEye/ocp-edge-ingress-module?ref=1.0.3"
  cluster_id       = module.ocp_base.cluster_id
...
module "service_mesh" {
  ...
  source                      = "git::https://github.ibm.com/GoldenEye/ocp-service-mesh-module?ref=1.17.0"
